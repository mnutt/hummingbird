...
var pixelHandler = function(req, res) {
  if (!auth.hasTrackerPermission(req.headers)) {
    console.log("Unauthorized tracker request", { permissions: req.headers['x-sandstorm-permissions'] });
    res.writeHead(403, {'Content-Type': 'text/plain'});
    res.end('Forbidden: invalid permissions');
    return;
  }
